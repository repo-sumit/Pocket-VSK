...
export const GSQAC_AREAS: GsqacArea[] = [
  {
    ...
    percent: 74.4, got: 387, max: 520, compare: { school: 74.4, district: 76.9, state: 75.3 },
    subdomains: [
      { id: "d1_periodic", name: "Periodic / Formative Tests", score: 68, indicators: [
      ...
      { id: "d1_terminal", name: "Terminal Tests I and II", score: 55, indicators: [
      ...
      { id: "d1_rwa", name: "Reading, Writing and Arithmetic", score: 80, indicators: [
  ...
  },
  {
    ...
    percent: 100, got: 50, max: 50, compare: { school: 100, district: 90.5, state: 88.6 },
    subdomains: [
      { id: "d2_mgmt", name: "School Management", score: 100, indicators: [
        "School development plan",
        "Functioning of School Management Committee (SMC)",
        "Maintenance of school records",
        "Budget planning and utilisation",
      ] },
      { id: "d2_safety", name: "Safety", score: 100, indicators: [
  ...
  },
  {
    ...
    percent: 82.8, got: 41.4, max: 50, compare: { school: 82.8, district: 77.0, state: 74.6 },
    subdomains: [
      { id: "d3_prayer", name: "Prayer Assembly", score: 92, indicators: [
        "Daily prayer assembly conducted",
        "Student participation in assembly",
        "News and thought of the day",
      ] },
      { id: "d3_yoga", name: "Yoga, Exercise and Sports", score: 88, indicators: [
        "Daily yoga and exercise",
        "Sports periods conducted",
        "Participation in sports events",
      ] },
      { id: "d3_special", name: "Participation in Special Activities", score: 72, indicators: [
        "Cultural programmes",
  ...
  },
  {
    ...
    percent: 80.4, got: 64.4, max: 80, compare: { school: 80.4, district: 73.9, state: 71.4 },
    subdomains: [
      { id: "d4_library", name: "Library Usage", score: 80, indicators: [
        "Library period scheduled in timetable",
        "Book issue register maintained",
        "Promotion of reading habit",
      ] },
      { id: "d4_tech", name: "Technology Usage", score: 60, indicators: [
        "ICT lab usage",
        "Use of digital learning content",
        "Smart classroom usage",
      ] },
      { id: "d4_mdm", name: "Mid-day Meal", score: 95, indicators: [
      ...
      { id: "d4_wash", name: "Water, Sanitation and Hygiene", score: 95, indicators: [
  ...
  {
    key: "D5", kpiId: "sq_d5", name: "State-Level Competitive Exams", name_gu: "રાજ્ય સ્તરની સ્પર્ધાત્મક પરીક્ષાઓ",
    percent: 46, got: 138, max: 300, compare: { school: 46.0, district: 42.6, state: 37.4 },
    subdomains: [
      { id: "d5_cet", name: "Participation in CET Exam", score: 40, indicators: [
      ...
      { id: "d5_cgms", name: "Participation in CGMS Exam", score: 52, indicators: [
...
export function gsqacIndicatorScore(subScore: number, i: number): number {
  ...
  return Math.max(20, Math.min(100, Math.round(subScore + offsets[i % offsets.length])));
}
