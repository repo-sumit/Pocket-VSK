...
/** Logout / exit-door icon (Docs/logout-svgrepo-com.svg) — clears session, returns to /login.
 *  Fill-based glyph (not stroked); inherits text colour via currentColor. */
export function LogoutArrow({ size = 18, className }: SvgIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} aria-hidden>
